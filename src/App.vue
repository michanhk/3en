...
<template>
  <div class="my-0 py-0" style="background-color: white; width: 100% max-width: 100%;">
    ...
    <div class="my-0 py-0" style="width: 100% max-width: 100%;">
      <video style="width: 100%; height: auto; min-width: 100%; max-width: 100%" poster="@/assets/invite.jpg" preload="none" autoplay loop muted playsinline webkit-playsinline><source src="@/assets/invite.mp4"></video>
    </div>
